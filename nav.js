...
(function () {
  ...
  /* ── FONT LOAD: reveal Material Symbols icons once font is ready ──
     Sets .fonts-loaded on <html> which triggers the opacity transition
     in nav.css. Fires immediately if font is already cached.           */
  function setupFontReveal() {
